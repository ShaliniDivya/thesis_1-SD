...
\subsection*{\ce{MoS2},\ce{MoSe2} nanoflowers}
 \begin{figure}[tbh!]
  \centering
  \includegraphics[width=\textwidth]{Figures/chap6fig/MoX2YNCDCsCEs}
    \caption{Peliminary electrochemical performance of Al/\ce{MoX2} cells using \ce{MoS2} and \ce{MoSe2} nanoflowers. Galvanostatic charge/discharge curves of a) Al/\ce{MoS2} cell and b) Al/\ce{MoSe2} cell at different rates. Cell efficiency of an c) Al/\ce{MoS2} and d) Al/\ce{MoSe2} cell in a two-electrode setup at various current rates.}
